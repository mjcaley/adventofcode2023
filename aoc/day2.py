...
def parse_play(play: str):
    ...
    for result in play.split(","):
        number, colour = parse_result(result)

        if colour == "red":
            play_result.red += number
        elif colour == "blue":
            play_result.blue += number
        else:
            play_result.green += number

    return play_result


def parse_plays(plays: str):
    for play in plays.split(";"):
        yield parse_play(play)


def parse_game(line: str):
    game_id, game_plays = line.split(":", 1)
    parsed_game_id = int(game_id.split()[1])
    parsed_plays = [play for play in parse_plays(game_plays)]

    return Game(parsed_game_id, parsed_plays)
...
def max_cubes(game: Game, max_red: int, max_blue:int , max_green: int):
    for play in game.plays:
        if play.red > max_red or play.blue > max_blue or play.green > max_green:
            return False
...
def p1(input: str):
    games = parse(input)
    result = sum(game.id for game in games if max_cubes(game, 12, 14, 13))
...
@app.command()
def test1():
    typer.echo(p1(test1_input))


@app.command()
def part1():
    typer.echo(p1(part1_input))


def min_plays(game: Game):
    result_play = game.plays[0]
    for play in game.plays:
        result_play.red = max(result_play.red, play.red)
        result_play.blue = max(result_play.blue, play.blue)
        result_play.green = max(result_play.green, play.green)

    return result_play.blue * result_play.red * result_play.green


def p2(input: str):
    powers = sum(min_plays(g) for g in parse(input))
    return powers


@app.command()
def test2():
    typer.echo(p2(test2_input))


@app.command()
def part2():
    typer.echo(p2(part2_input))

test1_input = """Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green"""

part1_input = """Game 1: 9 red, 2 green, 13 blue; 10 blue, 2 green, 13 red; 8 blue, 3 red, 6 green; 5 green, 2 red, 1 blue
...
test2_input = """Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green"""

part2_input = """Game 1: 9 red, 2 green, 13 blue; 10 blue, 2 green, 13 red; 8 blue, 3 red, 6 green; 5 green, 2 red, 1 blue
Game 2: 2 green, 2 blue, 16 red; 14 red; 13 red, 13 green, 2 blue; 7 red, 7 green, 2 blue
Game 3: 6 red, 4 green, 7 blue; 7 blue, 9 red, 3 green; 2 red, 4 green; 6 red, 2 blue; 7 blue, 9 red, 5 green
Game 4: 8 red, 2 green, 2 blue; 5 red, 2 blue, 3 green; 7 red, 9 green, 2 blue; 10 blue, 16 green, 1 red; 6 blue, 1 green, 8 red
Game 5: 12 blue, 6 red, 1 green; 10 green, 8 blue, 15 red; 1 green, 12 red, 11 blue; 3 green, 11 blue, 1 red; 7 blue, 5 red, 5 green; 11 green, 2 blue
