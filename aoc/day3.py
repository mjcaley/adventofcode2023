...
def parse(input: str) -> Tuple[list[Part], list[Symbol]]:
    parts = []
    symbols = []
    for x, line in enumerate(input.splitlines()):
        for part in re.finditer(r"\d+", line):
            parts.append(Part(x, part.start(), part.end(), int(part.group())))
        for symbol in re.finditer(r"[^0-9\.]", line):
            symbols.append(Symbol(x, symbol.start(), symbol.group()))

    return parts, symbols


def parts_near_symbols(parts: list[Part], symbols: list[Symbol]):
    for part in parts:
        for symbol in symbols:
            if symbol.line in range(part.line-1, part.line+2) and \
               symbol.row in range(part.begin-1, part.end+1):
                yield part
                break
...
def p1(input: str):
    ...
    return sum(part.id for part in parts_near_symbols(parts, symbols))
...
def symbols_near_parts(symbols: list[Symbol], parts: list[Part]):
    for symbol in symbols:
        adjacent = []
        for part in parts:
            if symbol.line in range(part.line-1, part.line+2) and \
        ...
        if len(adjacent) == 2:
            yield adjacent[0].id * adjacent[1].id


def p2(input: str):
    parts, symbols = parse(input)
    return sum(ratio for ratio in symbols_near_parts(symbols, parts))
...
part1_input = """...............307............130..................969...601...186.........................................312....628..........878..........
......479#../..*..............................#.....*......*............../309.....484........................*......-..........+.....89....
...
part2_input = """...............307............130..................969...601...186.........................................312....628..........878..........
......479#../..*..............................#.....*......*............../309.....484........................*......-..........+.....89....
...........726..352...461..69..............435.....390...625....................................459.........152...-....580............*.....
.......................*.......454*674.448......65................257....104*762....&..............*269.........558.&.....*907.........652..
.....................164.....-..............532*.....................................484......108........955.........252..........321.......
